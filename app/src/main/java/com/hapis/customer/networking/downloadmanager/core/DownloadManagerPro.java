package com.hapis.customer.networking.downloadmanager.core;
...
import com.hapis.customer.networking.downloadmanager.Utils.helper.FileUtils;
import com.hapis.customer.networking.downloadmanager.core.chunkWorker.Moderator;
import com.hapis.customer.networking.downloadmanager.core.enums.QueueSort;
import com.hapis.customer.networking.downloadmanager.core.enums.TaskStates;
import com.hapis.customer.networking.downloadmanager.core.mainWorker.AsyncStartDownload;
import com.hapis.customer.networking.downloadmanager.core.mainWorker.QueueModerator;
import com.hapis.customer.networking.downloadmanager.database.ChunksDataSource;
import com.hapis.customer.networking.downloadmanager.database.DatabaseHelper;
import com.hapis.customer.networking.downloadmanager.database.TasksDataSource;
...
import com.hapis.customer.networking.downloadmanager.report.ReportStructure;
import com.hapis.customer.networking.downloadmanager.report.exceptions.QueueDownloadInProgressException;
import com.hapis.customer.networking.downloadmanager.report.exceptions.QueueDownloadNotStartedException;
import com.hapis.customer.networking.downloadmanager.report.listener.DownloadManagerListener;
import com.hapis.customer.networking.downloadmanager.report.listener.DownloadManagerListenerModerator;
...
public class DownloadManagerPro {
    ...
    private static final String TAG = DownloadManagerPro.class.getName();
...
//        dbHelper.close();
    ...
    public void init(boolean internalStorage, String sdCardFolderAddress, int maxChunks, DownloadManagerListener listener) {
               ContextWrapper contextWrapper = new ContextWrapper(HapisApplication.getApplication());
        File directory = contextWrapper.getDir(sdCardFolderAddress, Context.MODE_PRIVATE);
        Log.d(TAG, "Internal Folder Path : " + directory.getAbsolutePath());
        File contentFile = new File(directory, ApplicationConstants.DB_FILE);
        Log.d(TAG, "Internal File Path : " + contentFile.getAbsolutePath());

        SAVE_FILE_FOLDER = contentFile.getAbsolutePath();
        maximumUserChunks = setMaxChunk(maxChunks);
        downloadManagerListener = new DownloadManagerListenerModerator(listener);
    }
