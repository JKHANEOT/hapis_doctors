...
import com.hapis.customer.ui.custom.badgenotifications.utils.BadgeDrawableBuilder;
import com.hapis.customer.ui.custom.badgenotifications.utils.BadgeStyle;
import com.hapis.customer.ui.custom.badgenotifications.utils.UIUtil;
...
public class ActionItemBadge {
    public enum BadgeStyles {
        ...
        TRANSPARENT(new BadgeStyle(BadgeStyle.Style.DEFAULT, R.layout.menu_action_item_badge, Color.parseColor("#00000000"), Color.parseColor("#00000000"), Color.TRANSPARENT));
...
//        TypefaceHelper.getInstance().setTypeface(badgeView, TypefaceHelper.getFont(TypefaceHelper.FONT.TAHOMA));
