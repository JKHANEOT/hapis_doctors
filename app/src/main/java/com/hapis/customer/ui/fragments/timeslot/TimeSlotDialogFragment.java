...
public class TimeSlotDialogFragment extends DialogFragment {
    ...
    public static final String TAG = TimeSlotDialogFragment.class.getName();
    ...
    private TimeSlotAdapter rcAdapter;
    ...
    public static TimeSlotDialogFragment newInstance(BaseFragmentActivity baseFragmentActivity, SelectDateAndTimeSlotCallBack selectDateAndTimeSlotCallBack, List<String> timeSlotsFromServer, List<String> selectedBookingTimeSlotList) {
        TimeSlotDialogFragment f = new TimeSlotDialogFragment();
        f.setOnCallBackListener(baseFragmentActivity, selectDateAndTimeSlotCallBack);
    ...
    public void setOnCallBackListener(BaseFragmentActivity baseFragmentActivity, SelectDateAndTimeSlotCallBack selectDateAndTimeSlotCallBack) {
    ...
    public void onViewCreated(View v, @Nullable Bundle savedInstanceState) {
        ...
        rcAdapter = new TimeSlotAdapter(getActivity(), mTimeSlotsFromServer, bookingTimeSlotAdapterCallBack);
...
//                AlertUtil.showAlert(mContext, mContext.getResources().getString(R.string.select_date), mContext.getResources().getString(R.string.please_select_a_date_to_continue), DialogIconCodes.DIALOG_NOT_AVAILABLE.getIconCode());
                Toast.makeText(mBaseFragmentActivity, mBaseFragmentActivity.getResources().getString(R.string.please_select_a_time_slot_to_continue), Toast.LENGTH_SHORT).show();
            }else{
                mSelectDateAndTimeSlotCallBack.updateSelectedTime(selectedBookingTimeSlotList, selectedIndex);
                dismiss();
            }
        }
    };
    ...
    TimeSlotAdapter.TimeSlotAdapterCallBack bookingTimeSlotAdapterCallBack = new TimeSlotAdapter.TimeSlotAdapterCallBack() {
        @Override
        public void addBookingTimeSlot(final String timeSlot, final int index) {
...
//                AlertUtil.showAlert(getActivity(), getResources().getString(R.string.select_time_slot), msg, DialogIconCodes.DIALOG_FAILED.getIconCode());
                Toast.makeText(mBaseFragmentActivity, msg, Toast.LENGTH_SHORT).show();
            }
        }
