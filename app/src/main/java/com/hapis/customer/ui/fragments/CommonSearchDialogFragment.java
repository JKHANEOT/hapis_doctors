...
import com.hapis.customer.ui.adapters.CommonSearchAdapter;
...
public class CommonSearchDialogFragment extends DialogFragment {

    public static final String TAG = CommonSearchDialogFragment.class.getName();

    public CommonSearchDialogFragment() {
        // Required empty public constructor
    }

    private CommonSearchCallBack mCommonSearchCallBack;
    ...
    public static CommonSearchDialogFragment newInstance(BaseFragmentActivity baseFragmentActivity, CommonSearchCallBack commonSearchCallBack, List<String> searchData, String screenTitle) {
        CommonSearchDialogFragment f = new CommonSearchDialogFragment();
        f.setOnCallBackListener(baseFragmentActivity, commonSearchCallBack);
    ...
    public void setOnCallBackListener(BaseFragmentActivity mBaseFragmentActivity, CommonSearchCallBack onCallBackListener) {
        mCommonSearchCallBack = onCallBackListener;
    ...
    public void onViewCreated(View v, @Nullable Bundle savedInstanceState) {
        ...
        //ADAPTER
        final CommonSearchAdapter adapter = new CommonSearchAdapter(baseFragmentActivity, mSearchData, new CommonSearchAdapter.CommonSelectedCallBack() {
            @Override
            public void onValueSelected(String selectedValue) {
                mCommonSearchCallBack.updateSelectedValue(selectedValue);
                dismiss();
            }
        });
