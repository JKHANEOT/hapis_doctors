...
//    private Typeface typeface;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            this.showPasswordIcon = typedArray.getResourceId(R.styleable.EditTextPassword_showPasswordIcon, R.drawable.ic_eye_inactive);
            this.hidePasswordIcon = typedArray.getResourceId(R.styleable.EditTextPassword_hidePasswordIcon, R.drawable.ic_eye_active);

//            String path = typedArray.getString(R.styleable.EditTextPassword_fontPath);
//            String defaultAppFont = TypefaceHelper.getFont(TypefaceHelper.FONT.LIGHT);
            /*if (path != null && path != defaultAppFont) {
                this.typeface = FontCache.getInstance().put(defaultAppFont, getContext().getAssets());
