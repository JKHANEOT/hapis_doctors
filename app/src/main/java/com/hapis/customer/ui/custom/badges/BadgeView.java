package com.hapis.customer.ui.custom.badges;
...
public class BadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Typeface regular = getResources().getFont(R.font.opensans_regular);
            mBadgeTextPaint.setTypeface(regular);
        } else {
            TextView textView = new TextView(getContext());
            textView.setTextAppearance(getContext(), R.style.regular_12sp);
            mBadgeTextPaint.setTypeface(textView.getTypeface());
        }
