...
public class CompletedSchedulesFrag extends BaseAbstractFragment<UpComingSchedulesFragmentViewModal> implements UpComingSchedulesFragmentView,
        UpComingSchedulesRecyclerViewAdapter.UpComingScheduleAdapterListeners {

    private View v;
    private static final String TAG = CompletedSchedulesFrag.class.getName();
        ...
        protected void onPostExecute(List<GroupDataListItem> consolidatedList) {
            ...
            if (consolidatedList != null && consolidatedList.size() > 0) {
                if (upcoming_appointments_rv != null) {
                    ...
                    mAdapter = new UpComingSchedulesRecyclerViewAdapter(consolidatedList, CompletedSchedulesFrag.this);
