...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int dropDownTitleColor;
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultErrorColor = context.getResources().getColor(R.color.app_color);
        ...
        disabledColor = array.getColor(R.styleable.MaterialSpinner_ms_disabledColor, defaultErrorColor);//context.getResources().getColor(R.color.disabled_color);
        ...
        dropDownTitleColor = array.getColor(R.styleable.MaterialSpinner_ms_dropDownTitleColor, baseColor);
        ...
        textSize = array.getDimension(R.styleable.MaterialSpinner_ms_textSize, DEFAULT_TEXT_SIZE);
    ...
    */
    ...
    public int getDropDownTitleColor() {
        return dropDownTitleColor;
    }

    public void setDropDownTitleColor(int dropDownTitleColor) {
        this.dropDownTitleColor = dropDownTitleColor;
        invalidate();
    }
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            final int resid = isDropDownView ? R.layout.spinner_dropdown_item : R.layout.spinner_item;
            ...
            if (isDropDownView) {
                textView.setTextColor(dropDownTitleColor);
            } else {
                textView.setTextColor(hintColor);
            }
            textView.setTag(HINT_TYPE);
//            TypefaceHelper.getInstance().setTypeface(textView, TypefaceHelper.getFont(TypefaceHelper.FONT.LIGHT));
            return textView;
        }
