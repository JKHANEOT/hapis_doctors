...
/**
 * Created by Javeed 03-10-2018.
 */

/** Advanced WebView component for Android that works as intended out of the box */
@SuppressWarnings("deprecation")
public class NhanceWebView extends WebView {
    ...
    public NhanceWebView(Context context) {
        super(context);
        init(context);
    }

    public NhanceWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NhanceWebView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public static boolean handleDownload(final Context context, final String fromUrl, final String toFilename) {
        ...
        // if the download manager app has been disabled on the device
            ...
            openAppSettings(context, NhanceWebView.PACKAGE_NAME_DOWNLOAD_MANAGER);
